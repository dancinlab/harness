---
description: /ing [show|add [--to <repo>]|done|next|pod ...|inject] — in-progress board → ING.jsonl (작업·POD·next; done=scrub; cross-repo handoff via --to). Triggers — "진행보드", "ING 등록", "작업 남겨놔", "ing add", "인계", "/ing", "ING 에 남겨".
